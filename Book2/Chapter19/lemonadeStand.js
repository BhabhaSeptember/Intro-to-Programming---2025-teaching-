...
function openTheStand() {
  ...
  // get input
  // type="number" in HTML only controls the input interface
  // (shows number keyboard on mobile),
  // but doesn't change the data type that JavaScript receives - a string
  // You still need Number() to actually convert it!
